...
const TASKS = [
  { id: 1, emoji: "🔍", title: "Найди ключ", desc: "Ключ спрятан в комнате. Ищи там, где обычно хранятся секреты!", done: false },
  { id: 2, emoji: "🧩", title: "Собери пазл", desc: "Сложи 4 части картинки вместе, чтобы узнать следующую подсказку.", done: false },
  { id: 3, emoji: "🔢", title: "Реши пример", desc: "7 + 5 = ? Введи ответ на кодовом замке.", done: false },
  { id: 4, emoji: "🌈", title: "Найди цвета", desc: "Найди 3 предмета: красный, синий и жёлтый. Принеси их на базу!", done: false },
  { id: 5, emoji: "🗺️", title: "Следуй по карте", desc: "Пройди 5 шагов на север, 3 шага на восток — там спрятан приз!", done: false },
];

const HINTS = [
  { id: 1, emoji: "💡", title: "Подсказка #1", text: "Ключ всегда прячут там, где меньше всего ожидаешь. Загляни под матрас или за книгу!", color: "from-yellow-400 to-orange-400" },
  { id: 2, emoji: "🌟", title: "Подсказка #2", text: "Части пазла спрятаны по углам комнаты. Смотри внимательно по периметру!", color: "from-purple-400 to-pink-400" },
  { id: 3, emoji: "🎯", title: "Подсказка #3", text: "Ответ на замке — это число двенадцать. Не забудь набрать его точно!", color: "from-green-400 to-cyan-400" },
];
